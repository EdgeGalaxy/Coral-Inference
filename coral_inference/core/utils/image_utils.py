...
def merge_frames(frames: Dict[str, np.ndarray], layout: str = 'grid', target_height: int = None) -> np.ndarray:
    """
    将多个视频帧合并为一张图片
    ...
    if layout == 'grid':
        ...
        for idx, frame in enumerate(frame_list):
            ...
            canvas[i*cell_height:(i+1)*cell_height, j*cell_width:(j+1)*cell_width] = resized_frame
